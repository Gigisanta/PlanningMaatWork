            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-4 pt-4">
                  <div className="p-4 bg-white rounded-3xl border-2 border-dashed border-[#E8E6E0]">
                    <div className="flex items-center gap-2 mb-3"><input type="checkbox" id="usar-termino-ia" checked={usarTerminoIA} onChange={(e) => setUsarTerminoIA(e.target.checked)} className="w-5 h-5 rounded-lg border-[#E8E6E0] text-[var(--primary-light)] focus:ring-[#3D7A5F] cursor-pointer" /><Label htmlFor="usar-termino-ia" className="text-xs font-black uppercase text-[#1F2D26] cursor-pointer">Término IA Autogenerado</Label></div>
                  ...
                  <div className="p-4 bg-white rounded-3xl border-2 border-dashed border-[#E8E6E0]">
                    <div className="flex items-center gap-2 mb-3"><input type="checkbox" id="usar-consejo-ia" checked={usarConsejoIA} onChange={(e) => setUsarConsejoIA(e.target.checked)} className="w-5 h-5 rounded-lg border-[#E8E6E0] text-[var(--primary-light)] focus:ring-[#3D7A5F] cursor-pointer" /><Label htmlFor="usar-consejo-ia" className="text-xs font-black uppercase text-[#1F2D26] cursor-pointer">Consejo IA Autogenerado</Label></div>
