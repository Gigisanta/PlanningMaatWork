...
function adjustWeights<K extends keyof any, T extends Record<K, number> & { locked?: boolean }>(items: T[], changedIndex: number, newValue: number, key: K): T[] {
...
function normalizeWeights<K extends keyof any, T extends Record<K, number> & { locked?: boolean }>(items: T[], key: K): T[] {
  const newItems = [...items]
