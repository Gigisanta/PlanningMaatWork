    ...
    <div className="fixed inset-0 z-[100] bg-white flex flex-col animate-in slide-in-from-bottom duration-300">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 py-2"><input id="asesor-recomendacion-desktop" type="checkbox" checked={asesorRecomendacion} onChange={(e) => setAsesorRecomendacion(e.target.checked)} className="w-5 h-5 rounded text-[var(--primary-light)] accent-[#3D7A5F] cursor-pointer" /><Label htmlFor="asesor-recomendacion-desktop" className="text-base cursor-pointer">Incluir recomendaciones</Label></div>
              ...
              <Popover>
                ...
                <PopoverContent className="w-80 bg-white border-[#E8E6E0] shadow-xl rounded-xl" align="end">
                  <div className="space-y-3 p-1">
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-[#F0EEE8]"><input id="asesor-recomendacion-mobile" type="checkbox" checked={asesorRecomendacion} onChange={(e) => setAsesorRecomendacion(e.target.checked)} className="rounded text-[var(--primary-light)] cursor-pointer" /><Label htmlFor="asesor-recomendacion-mobile" className="text-xs cursor-pointer">Incluir recomendaciones</Label></div>
