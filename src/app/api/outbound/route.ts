...
export async function GET() {
  try {
    ...
    // ⚡ Bolt: Consolidated 7 array passes into a single O(N) pass for byStage
    const byStage = { new: 0, outreach: 0, qualified: 0, meeting: 0, proposal: 0, won: 0, lost: 0 };
    ...
    // ⚡ Bolt: Consolidated 5 array passes into a single O(N) pass for outreachStats, preserving hierarchical logic
    const outreachStats = { totalSent: 0, delivered: 0, opened: 0, replied: 0, booked: 0 };
