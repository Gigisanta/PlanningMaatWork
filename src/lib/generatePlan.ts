...
export function generatePlanHTML(data: PlanData): string {
  ...
  // WhatsApp Share URL
  const whatsappMsg = data.asesorMensajePredefinido || `Hola, te comparto el contacto de mi asesor financiero ${data.asesorNombre || 'Giolivo Santarelli'} (Tel: ${data.asesorTelefono || ''}).`;
  ...
  <div class="container">
    ...
    <div class="client-cards">
      <div class="client-card">
        ...
        <div class="value">USD ${escapeHtml((data.aporteInicial || 0).toLocaleString())}</div>
      </div>
      <div class="client-card">
