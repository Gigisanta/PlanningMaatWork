  ...
  <div class="container">
    <div class="header">
      <div class="header-content">
        ...
        <div class="subtitle">${escapeHtml(data.profesion)} | ${escapeHtml(data.edad.toString())} años | Perfil ${escapeHtml(data.perfilRiesgo)}</div>
    ...
    <div class="welcome-section">
      ...
      <p class="welcome-text">
        ...
        perfil de riesgo y metas a ${escapeHtml(data.horizonteMeses.toString())} meses.
      </p>
    ...
    <div class="client-cards">
      <div class="client-card">
        ...
        <div class="value">${escapeHtml(data.edad.toString())} años</div>
      </div>
            <div class="client-card">
      ...
      <div class="client-card">
        ...
        <div class="value">${escapeHtml(data.horizonteMeses.toString())} meses</div>
      </div>
      <div class="client-card">
    ...
    <div class="section">
      ...
      <div class="objetivo-box">
        ...
        <div class="objetivo-meta">
          ...
          <div class="objetivo-meta-item">
            ...
            <span class="value">${escapeHtml(data.horizonteMeses.toString())} meses</span>
          </div>
          <div class="objetivo-meta-item">
      ...
      <div class="info-box">
        ...
        diseñamos una cartera que balancea crecimiento y protección. Tu edad de ${escapeHtml(data.edad.toString())} años
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>${escapeHtml(asig.porcentaje.toString())}%</td>
      ...
      <div class="progress-container">
        ...
        <div class="progress-item">
          <div class="progress-header">
            ...
            <span><strong>${escapeHtml(asig.porcentaje.toString())}%</strong></span>
          </div>
          <div class="progress-bar">
            <div class="progress-fill" style="width: ${escapeHtml(asig.porcentaje.toString())}%"></div>
          </div>
        ...
        <div class="instrument-card">
          ...
          <div class="allocation">
            <div class="allocation-bar">
              <div class="allocation-fill" style="width: ${escapeHtml(inst.asignacion.toString())}%"></div>
            </div>
            <span class="allocation-value">${escapeHtml(inst.asignacion.toString())}%</span>
          </div>
    ...
    <div class="section">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="badge badge-${r.nivel.toLowerCase()}">${escapeHtml(r.nivel)}</span></td>
      ...
      <div class="consejo-box">
        ...
        <p>${data.consejoFinal ? escapeHtml(data.consejoFinal) : (data.usarConsejoIA ? `Empezar a invertir joven es la mejor decisión financiera que podés tomar. No busques la perfección, buscá la consistencia. Con tiempo y disciplina, incluso aportes pequeños pueden crecer significativamente.` : '')}
