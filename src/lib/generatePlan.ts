...
export function generatePlanHTML(data: PlanData): string {
  ...
  // ⚡ Bolt: Consolidated 5 separate array passes (filter + reduce x5) into a single O(N) reduce pass.
  // This reduces array iterations from 5N to N, optimizing PDF HTML generation speed when processing portfolios with many instruments.
