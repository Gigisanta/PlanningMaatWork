  ...
  <div class="container">
    ...
    <div class="section">
      ...
      <div class="consejo-box">
        ...
        <p>${escapeHtml(data.consejoFinal) || (data.usarConsejoIA ? `Empezar a invertir joven es la mejor decisión financiera que podés tomar. No busques la perfección, buscá la consistencia. Con tiempo y disciplina, incluso aportes pequeños pueden crecer significativamente.` : '')}
