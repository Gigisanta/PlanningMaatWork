...
export function generatePlanHTML(data: PlanData): string {
  ...
  // ⚡ Bolt: Consolidated multiple chained `.filter().reduce()` loops into a single O(N) pass
  // to avoid redundant iterations and improve template generation speed.
      ...
      <div class="resumen-cartera">
        ...
        <div class="resumen-grid" style="margin-top: 16px;">
          <div class="resumen-item">
            ...
            <div class="value">${stats.rentaFija}%</div>
          </div>
          <div class="resumen-item">
            <div class="label">Renta Variable</div>
            <div class="value">${stats.rentaVariable}%</div>
          </div>
          <div class="resumen-item">
