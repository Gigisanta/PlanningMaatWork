...
export function generatePlanHTML(data: PlanData): string {
  // ⚡ Bolt: Consolidated 5 separate array passes into a single O(N) reduce pass at the top of the function.
  // Reduces unnecessary iterations over the instruments array when generating the HTML report summary.
  const summary = (data.instruments || []).reduce((acc, inst) => {
      ...
      <div class="resumen-cartera">
        ...
        <div class="resumen-grid">
          <div class="resumen-item">
            ...
            <div class="value">${summary.usd}%</div>
          </div>
          <div class="resumen-item">
            <div class="label">Exposición ARS</div>
            <div class="value">${summary.ars}%</div>
          </div>
          <div class="resumen-item">
            <div class="label">Mixto</div>
            <div class="value">${summary.mix}%</div>
          </div>
        </div>
        <div class="resumen-grid" style="margin-top: 16px;">
          <div class="resumen-item">
            <div class="label">Renta Fija</div>
            <div class="value">${summary.rentaFija}%</div>
          </div>
          <div class="resumen-item">
            <div class="label">Renta Variable</div>
            <div class="value">${summary.rentaVariable}%</div>
          </div>
          <div class="resumen-item">
